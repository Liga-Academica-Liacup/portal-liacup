...
**Versão 7 · 21 de agosto de 2026**
Documento mestre da fase de desenvolvimento. Complementa o documento de aceite v2.

*v2: ADR-0001 validado; contas, domínio e e-mail definidos; ADR-0002 e padrões de código acrescentados.*
*v3: Estatuto e Edital 02/2026 recebidos; nove pendências resolvidas e onze divergências levantadas.*
*v4: divergências decididas; F12 liberada; conteúdo de Projetos, Equipe e Processo Seletivo fechado.*
*v5: contas criadas, domínio registrado, ADR-0002 validado, F00 especificada.*
*v6: ADR-0003 aprovado (tokens, contraste e fontes). Spec da F00 validada com seis emendas. Registrada a exceção de arranque da F00 na `main`.*
...
| **GitHub** | `github.com/Liga-Academica-Liacup/portal-liacup` | **Criado e público** — visibilidade decidida no ADR-0001, seção 4.1 |
| **Vercel · Supabase · Resend** | Acesso via login do GitHub da liga | **Criadas** |
| **Endereço de produção** | `portal-liacup.vercel.app` | **No ar** — domínio próprio entra na F26 |
