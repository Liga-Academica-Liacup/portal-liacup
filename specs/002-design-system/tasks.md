...
- [X] T004 Acrescentar os 20 tokens inventariados em `src/estilos/tokens.css`, incluindo `--margem-abaixo-rotulo`, `--radius-xl` e `--opacidade-cartao-corpo`, sem alterar nenhum token existente, conforme a tabela de `data-model.md` (FR-005, FR-010, SC-006, SC-007)
