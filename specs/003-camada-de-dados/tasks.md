...
- [X] T021 [US2] Escrever as políticas das 11 coleções de conteúdo conforme a matriz de contracts/politicas-de-acesso.md: público lê só o publicado e não arquivado; a diretoria autenticada escreve; **remoção definitiva recusada até para a diretoria**, porque apagar arquiva (FR-009, FR-010, FR-028)
