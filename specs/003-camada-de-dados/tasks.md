...
- [ ] T006 Registrar no `README.md` a consequência do research.md D4: **alterar o banco pelo painel desalinha o repositório do que está no ar**, e quem fizer isso quebra a próxima migração. **Responde ao Princípio I**, não a um requisito numerado (Princípio I, sem FR/SC por definição)
